  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        link.href = "/AIDRUG (1).pdf"; // Make sure this path is correct
        link.setAttribute("download", "AIDRUG (1).pdf");
      ...
      >
        ...
        <div className="mt-4">
          <p className="text-gray-500 text-sm">
            ...
            <a href="/AIDRUG%20(1).pdf" download className="text-one underline font-semibold">
              Download Brochure Directly
            </a>
          </p>
        </div>
      </form>
